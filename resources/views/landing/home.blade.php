					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="landing/img/d1.jpg" alt="">
								</div>
								<div class="desc">	
						...
						<div class="col-lg-4">
							<div class="single-destination relative">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="landing/img/d3.jpg" alt="">
								</div>
								<div class="desc">	
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="img-fluid" src="landing/img/o1.jpg" alt="">					
								</div>
								<a href="#">
									<h4>Rent a Car</h4>
								</a>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="img-fluid" src="landing/img/o2.jpg" alt="">					
								</div>
								<a href="#">
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="img-fluid" src="landing/img/o3.jpg" alt="">					
								</div>
								<a href="#">
									<h4>To Do List</h4>
								</a>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-other-issue">
								<div class="thumb">
									<img class="img-fluid" src="landing/img/o4.jpg" alt="">					
								</div>
								<a href="#">
									<h4>Food Features</h4>
								</a>
		            ...
		            <div class="row">
		                <div class="active-testimonial">
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="img-fluid" src="landing/img/elements/user1.png" alt="">
		                        </div>
		                        <div class="desc">
		                            <p>
		                    ...
		                    <div class="single-testimonial item d-flex flex-row">
		                        <div class="thumb">
		                            <img class="img-fluid" src="landing/img/elements/user2.png" alt="">
		                        </div>
		                        <div class="desc">
		                            <p>
				...
				<div class="container-fluid">
					<div class="row align-items-center justify-content-end">
						...
						<div class="col-lg-6 col-md-12 home-about-right no-padding">
							<img class="img-fluid" src="landing/img/about-img.jpg" alt="">
						</div>
					</div>
				</div>	
			</section>
					...
					<div class="row">
						<div class="active-recent-blog-carusel">
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="img-fluid" src="landing/img/b1.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
							...
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="img-fluid" src="landing/img/b2.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
							...
							<div class="single-recent-blog-post item">
								<div class="thumb">
									<img class="img-fluid" src="landing/img/b3.jpg" alt="">
								</div>
								<div class="details">
									<div class="tags">
										<ul>
						...
						<div class="col-lg-3  col-md-6 col-sm-6">
							<div class="single-footer-widget mail-chimp">
								...
								<ul class="instafeed d-flex flex-wrap">
									<li><img src="landing/img/i1.jpg" alt=""></li>
									<li><img src="landing/img/i2.jpg" alt=""></li>
									<li><img src="landing/img/i3.jpg" alt=""></li>
									<li><img src="landing/img/i4.jpg" alt=""></li>
									<li><img src="landing/img/i5.jpg" alt=""></li>
									<li><img src="landing/img/i6.jpg" alt=""></li>
									<li><img src="landing/img/i7.jpg" alt=""></li>
									<li><img src="landing/img/i8.jpg" alt=""></li>
								</ul>
							</div>
						</div>						
					</div>
