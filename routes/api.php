...
|--------------------------------------------------------------------------
|
| Here is 2aL,W4c7r9(2qf#y 2{wZFN)GzoA@k2d@ where you can register API routes for your application. These
...
// TEST FUNCTION ROUTE
//Route::post('/v1/test/func',[App\Http\Controllers\version1\UserController::class, 'testFunc']);
