...
class CreateStockSellBacksTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('stock_sell_backs', function (Blueprint $table) {
            ...
            $table->string('stocksellback_receiving_bank_or_momo_account_name', 255);
            $table->string('stocksellback_receiving_bank_or_momo_account_number', 255);
            $table->string('stocksellback_receiving_bank_or_momo_name', 255);
